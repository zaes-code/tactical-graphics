...
export {RANGE_FANS, RANGE_FAN_BAND_OFFSET, RATIO_LOCK, baseVertexCount, handleContract, handleRole, isMovementGraphic, ratioLockOf, rotationAnchor} from './core/handles';
