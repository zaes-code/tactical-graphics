...
export {RANGE_FANS, RANGE_FAN_BAND_OFFSET, RATIO_LOCK, anchorVertex, baseVertexCount, handleContract, handleRole, isMovementGraphic, ratioLockOf, rotationAnchor} from './core/handles';
