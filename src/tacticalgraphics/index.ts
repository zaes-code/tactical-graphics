...
export {acrossPointAtEnd, drawsAsHairpin, firePositionBase, frontEdgeBase, hairpinBase, normalizeDrawnBase, synthesizedBase, usesFrontEdgeBase} from './core/drawnBase';
