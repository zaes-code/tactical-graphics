...
const HOST_DARK_PALETTE = {
    ...
    // `obstacleColors` is a separate boolean. The default softened to `#00AC00` in 4.2.0
    // for the same reason one step out; a host on a dark ground goes further still.
