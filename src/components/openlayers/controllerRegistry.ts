...
const CONTROLLER_REGISTRY: Record<TacticalGraphicName, ControllerFactory> = {
    ...
    [TacticalGraphicName.AntiTankDitchUnderConstruction]: explosivesReadiness,
    [TacticalGraphicName.AntiTankDitchCompleted]: explosivesReadiness,
    [TacticalGraphicName.AntiTankDitchReinforcedWithMines]: explosivesReadiness,
